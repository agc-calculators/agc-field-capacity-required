...
@Component({
    tag: 'agc-field-capacity-required-results'
})
                ...
                <div style={{display: this.ready ? 'block' : 'none'}}>
                    {this.data && (<ul class="agc-results">
                            <li>
                                ...
                                <span class="agc-results__value">{this.data['fieldCapacityRequired']}</span>
                                <sub>{this.data['units']['land']}/hour</sub>
                            </li>
                            <li>
                                <h2 data-i18n="results.land-worked-per-day">Land Worked per Day</h2>
                                <span class="agc-results__value">{this.data['landWorkedPerDay']}</span>
                                <sub>{this.data['units']['land']}/day</sub>
                            </li>                  
                        </ul>)}
                </div>
            </section>
